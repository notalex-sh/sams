...
<svelte:head>
  <title>
    {$isDirty ? '[*] ' : ''}SAMS - Secure Access Management System
...
<div class="relative z-10 min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-3 py-4">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div>
            <h1 class="text-2xl font-mono font-thin tracking-[0.2em] text-cyan-400 flicker">
              S.A.M.S
            </h1>
            <p class="text-[10px] uppercase tracking-[0.3em] text-gray-500 mt-0.5">
        ...
        <div class="flex items-center gap-1 text-xs font-mono uppercase tracking-widest text-gray-400">
  ...
  <main class="flex-1 container mx-auto px-2 py-6 animate-slide-up">
    {#if !$isAuthenticated}
